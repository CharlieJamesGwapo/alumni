...
.imgs{
    ...
    #imagesCarousel .carousel-item.active{
        ...
        background-color:rgb(255, 255, 255) !important; /* Maroon background */
    }

    .card-body.bg-primary {
        background-color:rgb(255, 255, 255) !important; /* Change blue to maroon */
    }

    .card-body.bg-info {
        background-color:rgb(255, 255, 255) !important; /* Change info color to maroon */
    }

    .card-body.bg-warning {
        background-color:rgb(255, 255, 255) !important; /* Change warning color to maroon */
    }
